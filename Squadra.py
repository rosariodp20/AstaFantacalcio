...
class Squadra:
    ...
    def getListaPortieri(self):
        return self.listaPortieri

    def getListaDifensori(self):
        return self.listaDifensori

    def getListaCentrocampisti(self):
        return self.listaCentrocampisti

    def getListaAttaccanti(self):
        return self.listaAttaccanti
