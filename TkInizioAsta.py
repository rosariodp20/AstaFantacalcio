...
def resettaValoriAsta():
    global labelNomeGiocatoreUltimaOfferta, labelValoreAttualeNumero, calciatorePOP, cbInizioAsta, bottoneIniziaAsta, bottoneProssimoGiocatore, labelTempo
...
def prossimoCalciatore():
    global finestra, calciatorePOP, listaPorteri, listaDifensori, listaCentrocampisti, listaAttaccanti, labelNomeCalciatore, labelSqCalciatore, flagAstaIniziata, labelR, labelTimer, labelRuolo, labelTempo, labelNomeUltimaOfferta, labelNomeGiocatoreUltimaOfferta, labelValoreAttuale, labelValoreAttualeNumero, labelStemma, labelCalciatore,labelTermine
    ...
    if contatoreP<(len(listaSquadre)*3):
        ...
        labelNomeCalciatore.config(text=" ")
        labelSqCalciatore.config(text=" ")
        labelR.config(text=" ")
        labelTimer.place_forget()
        labelTempo.place_forget()
        labelRuolo.place_forget()
        labelR.place_forget()
        labelNomeCalciatore.grid_remove()
        labelSqCalciatore.grid_remove()
        labelNomeUltimaOfferta.grid_remove()
        labelNomeGiocatoreUltimaOfferta.grid_remove()
        labelValoreAttualeNumero.grid_remove()
        labelValoreAttuale.grid_remove()
        labelStemma.place_forget()
        labelCalciatore.place_forget()
        labelTermine.place(x=430, y=50)
...
def inizializzazioneFinestra():
    ...
    infoSquadra1=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra2=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra3=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra4=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra5=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra6=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra7=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra8=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra9=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra10=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra11=Label(finestra, text=" ", relief=SUNKEN)
    infoSquadra12=Label(finestra, text=" ", relief=SUNKEN)
    ...
    ##logo
    image=Image.open("logoFantacalcio.png")
    image= image.resize((200, 130), Image.ANTIALIAS)
    logo= ImageTk.PhotoImage(image)
    labelLogo= Label(finestra, image=logo)
    labelLogo.place(x=30, y=100)

    ##stemma
    image1=Image.open("stemma.png")
    image1= image1.resize((80, 80), Image.ANTIALIAS)
    stemma= ImageTk.PhotoImage(image1)
    labelStemma= Label(finestra, image=stemma)
    labelStemma.place(x=708, y=10)

    ##calciatore
    image2=Image.open("calciatore.png")
    image2= image2.resize((50, 90), Image.ANTIALIAS)
    calIm= ImageTk.PhotoImage(image2)
    labelCalciatore= Label(finestra, image=calIm)
    labelCalciatore.place(x=420, y=10)

    ##label asta terminata
    image3=Image.open("astaTerminata.png")
    image3= image3.resize((438, 250), Image.ANTIALIAS)
    termine= ImageTk.PhotoImage(image3)
    labelTermine= Label(finestra, image=termine)
    labelTermine.place(x=5000, y=5000)
